...
export default class Touch {
  ...
  public singleTapTimeout: any;
  public longTapTimeout: any;
  public swipeTimeout: any;
  public x1: any;
  public x2: any;
  public y1: any;
  public y2: any;
  public preTapPosition: any;
  public lastZoom: number;
  public tempZoom: number;
  public _name: any;
  public _option: any;
  public rotate: any;
  public pinch: any;
  ...
  public tap: any;
  public longTap: any;
  public doubleTap: any;
  public singleTap: any;
  public touchCancel: any;
  public touchMove: any;
  public touchEnd: any;
  public pressMove: any;
  public touchStart: any;
  public multipointStart: any;
  public multipointEnd: any;
  ...
  move(evt) {
    ...
    if (len > 1) {
      ...
      if (preV.x !== null) {
        ...
        // TODO: 在三指的拖动的情况下增加方向判断，用于控制地图的俯仰角 skew
  ...
  destroy() {
    ...
    this.preV =
      ...
      this.longTapTimeout =
      this.swipeTimeout = this.x1 = this.x2 = this.y1 = this.y2 =
      this.preTapPosition = this.rotate = this.touchStart =
      this.multipointStart = this.multipointEnd =
      this.pinch = this.swipe = this.tap = this.doubleTap = this.longTap =
      this.singleTap = this.pressMove = this.touchMove = this.touchEnd =
